...
function findWasmBinary() {
    return locateFile('nim_wasm_tetris.wasm');
}
...
// Begin JS library code
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(10, 0, 1, len, prot, flags, fd, offset, allocated, addr);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(11, 0, 1, api);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(12, 0, 1, display, attrib_list, configs, config_size, numConfigs);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(13, 0, 1, display, config, hmm, contextAttribs);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(14, 0, 1, display, config, win, attrib_list);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(15, 0, 1, display, context);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(16, 0, 1, display, surface);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(17, 0, 1, display, config, attribute, value);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(18, 0, 1, nativeDisplayType);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(20, 0, 1, display, majorVersion, minorVersion);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(21, 0, 1, display, draw, read, context);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(22, 0, 1, display, name);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(23, 0, 1, dpy, surface);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(24, 0, 1, display, interval);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(25, 0, 1, display);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(27, 0, 1, nativeEngineId);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(32, 0, 1, status);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(35, 0, 1, index, gamepadState);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(37, 0, 1, width, height);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(38, 0, 1, target, deferUntilInEventHandler, fullscreenStrategy);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(39, 0, 1, target, deferUntilInEventHandler);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(41, 0, 1, userData, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(47, 0, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(62, 0, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(64, 0, 1, title);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(65, 0, 1, __environ, environ_buf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(66, 0, 1, penviron_count, penviron_buf_size);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(67, 0, 1, fd);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(68, 0, 1, fd, iov, iovcnt, pnum);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(69, 0, 1, fd, offset, whence, newOffset);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(70, 0, 1, fd, iov, iovcnt, pnum);
